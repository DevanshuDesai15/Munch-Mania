...
class todoFinalList extends StatefulWidget {
  @override
  _todoFinalListState createState() => _todoFinalListState();
}

class _todoFinalListState extends State<todoFinalList> {
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Container(
                                width:
                                    70, //height: MediaQuery.of(context).size.height/12,
                                decoration: BoxDecoration(
                                  border: Border(
                                    left: BorderSide(
                                      ...
                                      child: AlertDialog(
                                        ...
                                        content: Column(
                                          children: <Widget>[
                                            Center(
                                              child: Text(
                                                "Want to remove ${snapshot.data.documents[index].data["productName"]} from final list",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 22),
