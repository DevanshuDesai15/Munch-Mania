...
import 'package:food_recommendation/search/searchServiceForDessert.dart';

class searchDessert extends StatefulWidget {
  @override
  _searchDessertState createState() => _searchDessertState();
}

var productIdInput;

class _searchDessertState extends State<searchDessert> {
  var queryResultSet = [];
  var tempSearchStore = [];
  ...
  initiateSearch(value) {
    ...
    if (queryResultSet.length == 0 && value.length == 1) {
      SearchServiceForDessert().searchByName(value).then((docs) {
      ...
      Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              hintText: 'Search For Dessert Recipe',
              border:
...
Future abcd(String dishName) async {
  final data =
      await supabase.from('recipes').select().eq('category', 'dessert');
