...
class trendingDeserts extends StatefulWidget {
  @override
  _trendingDesertsState createState() => _trendingDesertsState();
}

class _trendingDesertsState extends State<trendingDeserts> {
  var color;

  late Future _trendingDessertData, _newlyAddedData;
  ...
  void initState() {
    super.initState();
    _trendingDessertData = getProfileData();
