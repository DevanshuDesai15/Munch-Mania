...
class searchBeverage extends StatefulWidget {
  @override
  _searchBeverageState createState() => _searchBeverageState();
}

var productIdInput;

class _searchBeverageState extends State<searchBeverage> {
  var queryResultSet = [];
  var tempSearchStore = [];
      ...
      Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              hintText: 'Search For Beverage Recipe',
              border:
